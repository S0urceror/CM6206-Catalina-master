...
// Originally from Dr.Lex, modified by LuisLiz
// S0urceror - ignore interface open error and continue, works on Sequoia without driverless kext
...
int main(int argc, const char * argv[])
{
	...
	for( int a=1; a<argc; a++ ) {
		if( strcmp( argv[a], "-d" ) == 0 ) {
			...
			printf( "CM6206Init version %s - S0urceror\n", CMVERSION );
			return 0;
		}
